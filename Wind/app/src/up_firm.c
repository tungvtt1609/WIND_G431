...
#define UDFW_CMD_UDFW				0xE0555049
#define UDFW_CMD_READ				0xA0555049
#define UDFW_CMD_SET				0xA1555049
...
static uint32_t up_cmd = 0;
//static UP_Function up_func_runtime = NULL;
static void WIND_UDFW_Start(void);


static up_cmd_t list_up_cmd[ID_UP_MAX] =
{
		{ID_UPDATE_FW,			0x495055E0,			UP_NONE,			NULL,				&WIND_UDFW_Start},
};
...
//	uint8_t rxdata[8];
//
//	if(true == HAL_UART_Receive_IT(&huart3, (uint8_t*)&rxdata, 8))
//	{
//
//		for(uint8_t i = 0; i < ID_UP_MAX; i++)
//		{
//			if(list_up_cmd[i].up_cmd == up_cmd)
//			{
